...
import com.cgm.experiments.blogapplicationdsl.utilities.toJsonApiArticlesTemplate
    ...
    fun `can read all articles`() {
        client.get("/api/oak-test/v1/articles")
            .andExpect {
                ...
                content { json(mapper.writeValueAsString(initialArticles.let(::toJsonApiArticlesTemplate))) }
            }
    }
